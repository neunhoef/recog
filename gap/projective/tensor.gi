...
function(ri,G)
  ...
  AddMethod(InitDataForImageRecogNode(ri).hints, FindHomMethodsProjective.KroneckerProduct, 2000);
...
function(ri, G)
  ...
  AddMethod(InitDataForKernelRecogNode(ri).hints, FindHomMethodsProjective.KroneckerKernel, 2000);
